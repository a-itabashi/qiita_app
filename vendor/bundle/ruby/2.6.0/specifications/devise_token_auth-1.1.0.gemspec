...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rails>.freeze, [">= 4.2.0", "< 6"])
      s.add_runtime_dependency(%q<devise>.freeze, ["> 3.5.2", "< 4.7"])
      ...
      s.add_dependency(%q<rails>.freeze, [">= 4.2.0", "< 6"])
      s.add_dependency(%q<devise>.freeze, ["> 3.5.2", "< 4.7"])
